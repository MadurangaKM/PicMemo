...
//  PicMemo
//
//  Created by Maduranga  on 3/30/17.
//  Copyright © 2017 Maduranga . All rights reserved.
//
...
class MemoryViewController: UICollectionViewController, UIImagePickerControllerDelegate,UINavigationControllerDelegate , UICollectionViewDelegateFlowLayout,AVAudioRecorderDelegate{
    ...
    @IBAction func helpBtton(_ sender: AnyObject) {
        

    }
   
    @IBAction func helpB(_ sender: AnyObject) {
        createAlert(title: "Help", message: "Please add your photos using plus button, long touch the photo and record your voice into photo")
    }
